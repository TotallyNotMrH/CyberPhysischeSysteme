...
void writeWebsite(WiFiClient *client) {
  ...
  client->println("<p>LED #2 - >Current State: " + state2Text + "</p>");
  // If the output27State is off, it displays the ON button       
  if (state2Text=="off") {
    client->println("<p><a href=\"/LED2/on\"><button class=\"button\">TURN ON</button></a></p>");
  } else {
    client->println("<p><a href=\"/LED2/off\"><button class=\"button button2\">TURN OFF</button></a></p>");
  }
